...
import { genAI, CHAT_MODEL, USE_OLLAMA, OLLAMA_HOST, OLLAMA_CHAT_MODEL } from '@/lib/config';
...
When you reference information from documents, try to be specific about the source and location when possible, as this will help users understand where the information comes from.`;
    ...
    // Use Ollama or Google AI based on configuration
    let response = '';
    
    console.log('Chat configuration:', { USE_OLLAMA, OLLAMA_HOST, OLLAMA_CHAT_MODEL });
