    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-24">
        <div className="text-center mb-8">
          ...
          <p className="mt-3 max-w-xl mx-auto text-xl text-gray-500 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                {activeTab === 'upload' ? (
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-5 text-blue-800 dark:text-blue-300">Google Drive Integration</h2>
                      ...
                      {isGoogleAuthenticated ? (
                        <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 shadow-sm">
                          <div className="flex items-center justify-center mb-4 text-green-600">
                            ...
                            <span className="font-semibold text-lg text-green-700">✅ Connected to Google Drive</span>
                          </div>
                          ...
                          <Button
                            variant="outline"
                            className="inline-flex items-center mb-2 bg-blue-100 border-blue-300 text-blue-700 hover:bg-blue-200 w-full justify-center py-3 text-base font-medium"
                            onClick={() => {
                              window.location.href = '/drive/files';
                            }}
                          >
                            <span className="mr-2">📂</span>
                            Browse My Google Drive Files
                          </Button>
                        </div>
                      ) : (
                        <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-5 shadow-sm">
                          ...
                          <Button
                            variant="default"
                            className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white w-full justify-center py-3 text-base font-medium"
                          ...
                          >
                            {isLoadingAuth ? (
                              ...
                              <>
                                <span className="mr-2">🔄</span>
                                Connect Google Drive via OAuth2
                              </>
                            )}
                          </Button>
                          <p className="text-xs text-gray-700 dark:text-gray-300 mt-4 text-center">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-xl overflow-hidden mt-10">
          <div className="md:flex">
            <div className="p-8 md:p-12 md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="default" size="lg" className="bg-white text-indigo-600 hover:bg-indigo-50" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
                  Get Started
                </Button>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-lg">
                  ...
                  <div className="space-y-4">
                    <div className="bg-indigo-700/50 rounded-lg p-3 text-white/90">
                      ...
                      <p>What is the main conclusion in the Q3 financial report?</p>
                    </div>
                    <div className="bg-white/10 rounded-lg p-3 text-white/90">
                      <p className="text-xs text-white/70">AI Assistant</p>
                      <p>Based on the Q3 financial report, the main conclusion is that revenue increased by 27% year-over-year, exceeding projections by 12%. This was primarily driven by the new product line launched in Q2.</p>
                    </div>
                  </div>
                </div>
              </div>
