      ...
      <div className={`flex flex-col h-full transition-all duration-300 ${sidebarOpen ? 'md:ml-64' : ''}`}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold text-gray-800">Document Q&A Chat</h1>
          </div>
        ...
        {messages.length === 0 ? (
          ...
          messages.map((message, index) => {
            ...
            return (
              <div
                key={message.id}
                className={`flex ${message.isUser ? 'justify-end' : 'justify-start'} ${isSameSender ? 'mt-1' : 'mt-4'}`}
              >
      ...
      <div className="border-t p-4">
        ...
        <div className="flex space-x-2">
          <textarea
            ...
            className="flex-1 border-2 border-blue-300 rounded-lg p-3 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 bg-white placeholder-gray-700 text-base min-h-[48px] shadow-sm"
            rows={2}
            disabled={isLoading}
            style={{
              color: '#000000',
          ...
          <button
            ...
            className="bg-green-500 text-white px-3 py-2 rounded-lg hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center text-sm"
