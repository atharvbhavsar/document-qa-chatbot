...
export default function GoogleDriveAuth({ onAuthSuccess, isAuthenticated }: GoogleDriveAuthProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-500">
        Connect your Google Drive to search and ask questions about your documents
      </p>
    </div>
  );
}
